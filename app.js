...
const floorData={
 b1:{name:'지하 1층',image:'assets/지하평면도.png',locations:[['west-elevator','서측 엘리베이터 홀'],['control-room','중앙 관리실'],['east-elevator','동측 엘리베이터 홀']],exits:[['서쪽 비상구',8,40],['중앙 비상구 1',30,63],['중앙 비상구 2',54,65],['동쪽 비상구',91,49]]},
 '1f':{name:'1층',image:'assets/전시동 1층.png',locations:[['hall1','제1전시장'],['hall2','제2전시장'],['hall3','제3전시장'],['multi','다목적홀']],exits:[['서쪽 비상구',8,49],['서남쪽 비상구',49,91],['동북쪽 비상구',91,40],['동쪽 비상구',92,67],['동남쪽 비상구',88,82]]},
 '2f':{name:'2층',image:'assets/전시동 2층.png',locations:[['201','201호'],['202','202호'],['203','203호'],['204','204호'],['205','205호'],['206','206호'],['207','207호'],['208','208호'],['209','209호'],['210','210호'],['211','211호'],['212','212호'],['213','213호'],['214','214호']],exits:[['서쪽 비상구',7,65],['서북쪽 비상구',10,37],['중앙 비상구 1',44,65],['중앙 비상구 2',62,65],['동북쪽 비상구',91,43],['동쪽 비상구',88,78]]},
 '3f':{name:'3층',image:'assets/전시동 3층.png',locations:[['301','301호'],['302','302호'],['303','303호'],['304','304호'],['305','305호'],['306','306호'],['307','307호']],exits:[['서북쪽 비상구',18,27],['서남쪽 비상구',12,82],['동쪽 비상구',92,52]]}
};
...
const navigation={
 b1:{rooms:{
  ...
  nodes:{west:[8,40],w:[25,63],c1:[30,63],c2:[54,65],c3:[70,65],e:[84,58],east:[91,49]},
  links:[['west','w'],['w','c1'],['c1','c2'],['c2','c3'],['c3','e'],['e','east']],
  exitNodes:{'서쪽 비상구':'west','중앙 비상구 1':'c1','중앙 비상구 2':'c2','동쪽 비상구':'east'}},
 '1f':{rooms:{
  hall1:[[17,25,39,48],[32,52],'c2'],hall2:[[40,27,61,51],[51,53],'c3'],
  hall3:[[62,31,82,53],[72,55],'c4'],multi:[[13,64,43,83],[38,62],'c2']},
  nodes:{west:[8,49],c1:[18,57],c2:[36,57],c3:[55,58],c4:[73,59],c5:[86,59],ne:[91,40],east:[92,67],se:[88,82],sw:[49,91]},
  links:[['west','c1'],['c1','c2'],['c2','c3'],['c3','c4'],['c4','c5'],['c5','ne'],['c5','east'],['east','se'],['c3','sw']],
  exitNodes:{'서쪽 비상구':'west','서남쪽 비상구':'sw','동북쪽 비상구':'ne','동쪽 비상구':'east','동남쪽 비상구':'se'}},
 '2f':{rooms:{
  ...
  nodes:{nw:[10,37],west:[7,65],u0:[10,52],u1:[18,52],u2:[23,52],u3:[31,52],u4:[39,52],u5:[46,52],u6:[54,52],u7:[62,52],u8:[72,52],u9:[82,52],c1:[44,65],c2:[62,65],v1:[55,71],v2:[55,79],v3:[55,87],r1:[70,87],r2:[72,79],right:[84,72],ne:[91,43],east:[88,78]},
  links:[['nw','u0'],['west','u0'],['u0','u1'],['u1','u2'],['u2','u3'],['u3','u4'],['u4','u5'],['u5','u6'],['u6','u7'],['u7','u8'],['u8','u9'],['u6','v1'],['v1','v2'],['v2','v3'],['v3','r1'],['r1','r2'],['r2','right'],['u9','ne'],['u9','right'],['right','east']],
  exitNodes:{'서쪽 비상구':'west','서북쪽 비상구':'nw','중앙 비상구 1':'c1','중앙 비상구 2':'c2','동북쪽 비상구':'ne','동쪽 비상구':'east'}},
 '3f':{rooms:{
  ...
  nodes:{nw:[18,27],c1:[18,57],c2:[30,57],c3:[45,57],c4:[60,57],c5:[71,57],c6:[84,57],east:[92,52],sw1:[18,78],sw:[12,82]},
  links:[['nw','c1'],['c1','c2'],['c2','c3'],['c3','c4'],['c4','c5'],['c5','c6'],['c6','east'],['c1','sw1'],['sw1','sw']],
  exitNodes:{'서북쪽 비상구':'nw','서남쪽 비상구':'sw','동쪽 비상구':'east'}}
};
